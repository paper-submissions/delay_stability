...
def multi_transform(transform_fn, duplicates=1, dim=0):
    """preforms multiple transforms, useful to implement inference time augmentation or
     "batch augmentation" taken from https://github.com/eladhoffer/convNet.pytorch
    """
    if duplicates > 1:
...
def get_transform(transform_name='imagenet', input_size=None,
    ...
    transform_fn = None
    if transform_name == 'imagenet' or transform_name == 'tiny-imagenet':  # inception augmentation is default for imagenet
